...
var DataService = /** @class */ (function () {
    function DataService(http) {
        ...
        this.baseStatesUrl = '/api/products';
    }
    ...
    DataService.prototype.insertProduct = function (product) {
        return this.http.post(this.baseStatesUrl, product)
            .map(function (data) {
    ...
    DataService.prototype.updateProduct = function (product) {
        return this.http.put(this.baseStatesUrl + '/' + product.id, product)
            .map(function (data) {
    ...
    DataService.prototype.deleteProduct = function (id) {
        return this.http.delete(this.baseStatesUrl + '/' + id)
            .catch(this.handleError);
    };
